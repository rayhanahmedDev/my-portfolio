            ...
            <div className="navbar bg-[#18315A] md:px-36 py-8">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 text-white">
                          {links}
                        </ul>
                    </div>
                    <h2 className="text-3xl font-bold"><span className="text-[#FE3E57]">Rayhan</span></h2>
                </div>
